...
ggplot()+
  ...
  geom_hex(data=filter(filtered.data, SAMPLE=="1658_E04"),aes(x = FSC.A, y =  FL2.A), bins = 128,colour="red") + 
  scale_y_continuous(trans="log10")+ 
  scale_x_continuous(trans="log10") + 
  theme_classic() + 
  theme(legend.position="none")
...
ggplot()+
  ...
  geom_hex(data=filter(filtered.data, SAMPLE=="1658_2"),aes(x = FSC.A, y =  FL1.A), bins = 128,colour="green") + 
  scale_y_continuous(trans="log10")+ 
  scale_x_continuous(trans="log10") + 
  theme_classic() + 
  theme(legend.position="none")
...
ggplot()+
  ...
  geom_hex(data=filter(filtered.data, SAMPLE=="1658_2"),aes(x = FSC.A, y =  FL2.A), bins = 128,colour="red") + 
  scale_y_continuous(trans="log10")+ 
  scale_x_continuous(trans="log10") + 
  theme_classic() + 
  theme(legend.position="none")
...
ggplot()+
  geom_hex(data=filter(filtered.data, SAMPLE=="FY4_E01"),aes(x = FSC.A, y =  FL1.A), bins = 128,colour="blue") + 
  geom_hex(data=filter(filtered.data, SAMPLE=="HXT6n7_mCherry_7_E03"),aes(x = FSC.A, y =  FL1.A), bins = 128,colour="green") + 
  scale_y_continuous(trans="log10")+ 
  scale_x_continuous(trans="log10") + 
  theme_classic() + 
  theme(legend.position="none")
...
ggplot()+
  geom_hex(data=filter(filtered.data, SAMPLE=="FY4_E01"),aes(x = FSC.A, y =  FL2.A), bins = 128,colour="blue") + 
  geom_hex(data=filter(filtered.data, SAMPLE=="HXT6n7_mCherry_7_E03"),aes(x = FSC.A, y =  FL2.A), bins = 128,colour="red") + 
  scale_y_continuous(trans="log10")+ 
  scale_x_continuous(trans="log10") + 
  theme_classic() + 
  theme(legend.position="none")
...
ggplot()+
  geom_hex(data=filter(filtered.data, SAMPLE=="FY4_1"),aes(x = FSC.A, y =  FL1.A), bins = 128,colour="blue") + 
  geom_hex(data=filter(filtered.data, SAMPLE=="HXT6n7_mCherry_7_6"),aes(x = FSC.A, y =  FL1.A), bins = 128,colour="green") + 
  scale_y_continuous(trans="log10")+ 
  scale_x_continuous(trans="log10") + 
  theme_classic() + 
  theme(legend.position="none")
...
ggplot()+
  geom_hex(data=filter(filtered.data, SAMPLE=="FY4_1"),aes(x = FSC.A, y =  FL2.A), bins = 128,colour="blue") + 
  geom_hex(data=filter(filtered.data, SAMPLE=="HXT6n7_mCherry_7_6"),aes(x = FSC.A, y =  FL2.A), bins = 128,colour="red") + 
  scale_y_continuous(trans="log10")+ 
  scale_x_continuous(trans="log10") + 
  theme_classic() + 
  theme(legend.position="none")
...
ggplot()+
  geom_hex(data=filter(filtered.data, SAMPLE=="FY4_E01"),aes(x = FSC.A, y =  FL1.A), bins = 128,colour="blue") + 
  geom_hex(data=filter(filtered.data, SAMPLE=="3D_G02"),aes(x = FSC.A, y =  FL1.A), bins = 128,colour="green") + 
  scale_y_continuous(trans="log10")+ 
  scale_x_continuous(trans="log10") + 
  theme_classic() + 
  theme(legend.position="none")
...
ggplot()+
  geom_hex(data=filter(filtered.data, SAMPLE=="FY4_E01"),aes(x = FSC.A, y =  FL2.A), bins = 128,colour="blue") + 
  geom_hex(data=filter(filtered.data, SAMPLE=="3D_G02"),aes(x = FSC.A, y =  FL2.A), bins = 128,colour="red") + 
  scale_y_continuous(trans="log10")+ 
  scale_x_continuous(trans="log10") + 
  theme_classic() + 
  theme(legend.position="none")
...
ggplot()+
  geom_hex(data=filter(filtered.data, SAMPLE=="FY4_1"),aes(x = FSC.A, y =  FL1.A), bins = 128,colour="blue") + 
  geom_hex(data=filter(filtered.data, SAMPLE=="3D_8"),aes(x = FSC.A, y =  FL1.A), bins = 128,colour="green") + 
  scale_y_continuous(trans="log10")+ 
  scale_x_continuous(trans="log10") + 
  theme_classic() + 
  theme(legend.position="none")
...
ggplot()+
  geom_hex(data=filter(filtered.data, SAMPLE=="FY4_1"),aes(x = FSC.A, y =  FL2.A), bins = 128,colour="blue") + 
  geom_hex(data=filter(filtered.data, SAMPLE=="3D_8"),aes(x = FSC.A, y =  FL2.A), bins = 128,colour="red") + 
  scale_y_continuous(trans="log10")+ 
  scale_x_continuous(trans="log10") + 
  theme_classic() + 
  theme(legend.position="none")
